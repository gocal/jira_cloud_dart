...
class _$JsonNodeSerializer implements StructuredSerializer<JsonNode> {
  ...
  Iterable<Object> serialize(Serializers serializers, JsonNode object,
    ...
    if (object.intType != null) {
      result
        ..add('int')
        ..add(serializers.serialize(object.intType,
            specifiedType: const FullType(bool)));
    }
    if (object.longType != null) {
      result
        ..add('long')
        ..add(serializers.serialize(object.longType,
            specifiedType: const FullType(bool)));
    }
    if (object.doubleType != null) {
      result
        ..add('double')
        ..add(serializers.serialize(object.doubleType,
            specifiedType: const FullType(bool)));
    }
    ...
    while (iterator.moveNext()) {
      ...
      switch (key) {
        ...
        case 'integralNumber':
          ...
          break;
        case 'int':
          result.intType = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'long':
          result.longType = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'double':
          result.doubleType = serializers.deserialize(value,
              specifiedType: const FullType(bool)) as bool;
          break;
        case 'bigDecimal':
                                                        ...
                                                        $jc(
                                                            $jc(
                                                                $jc(
                                                                    $jc(
                                                                        $jc(
                                                                            $jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc($jc(0, elements.hashCode), missingNode.hashCode), object.hashCode), floatingPointNumber.hashCode), valueNode.hashCode), containerNode.hashCode), number.hashCode), pojo.hashCode), integralNumber.hashCode), intType.hashCode), longType.hashCode), doubleType.hashCode), bigDecimal.hashCode), bigInteger.hashCode), textual.hashCode), boolean.hashCode), binary.hashCode),
...
class JsonNodeBuilder implements Builder<JsonNode, JsonNodeBuilder> {
  ...
  bool _intType;
  bool get intType => _$this._intType;
  set intType(bool intType) => _$this._intType = intType;

  bool _longType;
  bool get longType => _$this._longType;
  set longType(bool longType) => _$this._longType = longType;

  bool _doubleType;
  bool get doubleType => _$this._doubleType;
  set doubleType(bool doubleType) => _$this._doubleType = doubleType;
  ...
  JsonNodeBuilder get _$this {
    if (_$v != null) {
      ...
      _intType = _$v.intType;
      _longType = _$v.longType;
      _doubleType = _$v.doubleType;
