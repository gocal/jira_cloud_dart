...
class PermissionsApi {
  ...
  Future<Response<Permissions>> getAllPermissions({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/permissions";
  ...
  Future<Response<BulkPermissionGrants>> getBulkPermissions(
    BulkPermissionsRequestBean bulkPermissionsRequestBean, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/permissions/check";
  ...
  Future<Response<Permissions>> getMyPermissions({
    String projectKey,
    String projectId,
    String issueKey,
    String issueId,
    ...
    String _path = "/rest/api/2/mypermissions";
  ...
  Future<Response<PermittedProjects>> getPermittedProjects(
    PermissionsKeysBean permissionsKeysBean, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/permissions/project";
