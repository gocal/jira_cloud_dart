...
class ProjectRolesApi {
  ...
  Future<Response<List<ProjectRole>>>
    ...
    String _path = "/rest/api/3/project/{projectIdOrKey}/roledetails"
    ...
    return _dio
      ...
      cancelToken: cancelToken,
        ...
        .then((response) {
      final FullType type =
          const FullType(BuiltList, const [const FullType(ProjectRole)]);
      BuiltList<ProjectRole> dataList =
  ...
  Future<Response<Map<String, String>>>
    ...
    String _path = "/rest/api/3/project/{projectIdOrKey}/role"
        .replaceAll("{" r'projectIdOrKey' "}", projectIdOrKey.toString());
    ...
    return _dio
      ...
      var data = _serializers.deserializeWith<Map<String, String>>(
  ...
  Future<Response>
    ...
    String _path =
        "/rest/api/3/role/{id}".replaceAll("{" r'id' "}", id.toString());
