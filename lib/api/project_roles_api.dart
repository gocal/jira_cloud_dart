...
class ProjectRolesApi {
    ...
    ProjectRolesApi(this._dio, this._serializers);
        ...
        Future<Response<List<ProjectRole>>>comAtlassianJiraRestV2IssueProjectProjectRoleDetailsResourceGetProjectRoleDetailsGet(String projectIdOrKey,{ bool currentMember,bool excludeConnectAddons,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/rest/api/3/project/{projectIdOrKey}/roledetails".replaceAll("{" r'projectIdOrKey' "}", projectIdOrKey.toString());

        Map<String, dynamic> queryParams = {};
        Map<String, String> headerParams = Map.from(headers ?? {});
        dynamic bodyData;

                queryParams[r'currentMember'] = currentMember;
        ...
        List<String> contentTypes = [];
            ...
            cancelToken: cancelToken,
                ...
                final FullType type = const FullType(BuiltList, const [const FullType(ProjectRole)]);
                BuiltList<ProjectRole> dataList = _serializers.deserialize(response.data, specifiedType: type);
                var data = dataList.toList();

            return Response<List<ProjectRole>>(
                data: data,
        ...
        Future<Response<ProjectRole>>comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRoleGet(String projectIdOrKey,int id,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/rest/api/3/project/{projectIdOrKey}/role/{id}".replaceAll("{" r'projectIdOrKey' "}", projectIdOrKey.toString()).replaceAll("{" r'id' "}", id.toString());
        ...
        var data = _serializers.deserializeWith<ProjectRole>(serializer, response.data);
        ...
        Future<Response<Map<String, String>>>comAtlassianJiraRestV2IssueProjectProjectRoleResourceGetProjectRolesGet(String projectIdOrKey,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/rest/api/3/project/{projectIdOrKey}/role".replaceAll("{" r'projectIdOrKey' "}", projectIdOrKey.toString());
        ...
        var serializer = _serializers.serializerForType(Map<String, String>);
        var data = _serializers.deserializeWith<Map<String, String>>(serializer, response.data);
        ...
        Future<Response<ProjectRole>>comAtlassianJiraRestV2IssueProjectRoleResourceCreateProjectRolePost(CreateUpdateRoleRequestBean createUpdateRoleRequestBean,{ CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/rest/api/3/role";
        ...
        List<String> contentTypes = ["application/json"];
            ...
            var serializedBody = _serializers.serialize(createUpdateRoleRequestBean);
            var jsoncreateUpdateRoleRequestBean = json.encode(serializedBody);
            bodyData = jsoncreateUpdateRoleRequestBean;
        ...
        Future<Response>comAtlassianJiraRestV2IssueProjectRoleResourceDeleteProjectRoleDelete(int id,{ int swap,CancelToken cancelToken, Map<String, String> headers,}) async {

        String _path = "/rest/api/3/role/{id}".replaceAll("{" r'id' "}", id.toString());

        Map<String, dynamic> queryParams = {};
        Map<String, String> headerParams = Map.from(headers ?? {});
        dynamic bodyData;

                queryParams[r'swap'] = swap;
        queryParams.removeWhere((key, value) => value == null);
        headerParams.removeWhere((key, value) => value == null);
        ...
        Future<Response<ProjectRole>>comAtlassianJiraRestV2IssueProjectRoleResourceFullyUpdateProjectRolePut(int id,CreateUpdateRoleRequestBean createUpdateRoleRequestBean,{ CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        Future<Response<List<ProjectRole>>>comAtlassianJiraRestV2IssueProjectRoleResourceGetAllProjectRolesGet({ CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        Future<Response<ProjectRole>>comAtlassianJiraRestV2IssueProjectRoleResourceGetProjectRoleByIdGet(int id,{ CancelToken cancelToken, Map<String, String> headers,}) async {
        ...
        Future<Response<ProjectRole>>comAtlassianJiraRestV2IssueProjectRoleResourcePartialUpdateProjectRolePost(int id,CreateUpdateRoleRequestBean createUpdateRoleRequestBean,{ CancelToken cancelToken, Map<String, String> headers,}) async {
