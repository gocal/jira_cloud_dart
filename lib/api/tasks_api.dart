  ...
  Future<Response<TaskProgressBeanObject>> getTask(
    ...
    return _dio
      ...
      cancelToken: cancelToken,
        ...
        .then((response) {
      var serializer = _serializers.serializerForType(TaskProgressBeanObject);
      var data = _serializers.deserializeWith<TaskProgressBeanObject>(
          serializer, response.data);

      return Response<TaskProgressBeanObject>(
        data: data,
        headers: response.headers,
        request: response.request,
        redirects: response.redirects,
