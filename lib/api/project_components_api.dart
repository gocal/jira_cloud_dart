...
class ProjectComponentsApi {
  ...
  Future<Response<Component>> createComponent(
    Component component, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/component";
  ...
  Future<Response> deleteComponent(
    String id, {
    String moveIssuesTo,
    CancelToken cancelToken,
    Map<String, String> headers,
    ...
    String _path =
        "/rest/api/2/component/{id}".replaceAll("{" r'id' "}", id.toString());
  ...
  Future<Response<ComponentIssuesCount>> getComponentRelatedIssues(
    String id, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/component/{id}/relatedIssueCounts"
  ...
  Future<Response<List<Component>>> getProjectComponents(
    String projectIdOrKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/{projectIdOrKey}/components"
  ...
  Future<Response<PageBeanComponentWithIssueCount>>
    ...
    String _path = "/rest/api/2/project/{projectIdOrKey}/component"
        .replaceAll("{" r'projectIdOrKey' "}", projectIdOrKey.toString());
  ...
  Future<Response<Component>> updateComponent(
    String id,
    Component component, {
    CancelToken cancelToken,
    Map<String, String> headers,
