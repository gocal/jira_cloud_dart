...
class IssueVotesApi {
  ...
  IssueVotesApi(this._dio, this._serializers);
  ...
  Future<Response<Object>> addVote(
    String issueIdOrKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}/votes"
  ...
  Future<Response<Votes>> getVotes(
    String issueIdOrKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    ...
    return _dio
      ...
      cancelToken: cancelToken,
        ...
        .then((response) {
      var serializer = _serializers.serializerForType(Votes);
      var data = _serializers.deserializeWith<Votes>(serializer, response.data);
