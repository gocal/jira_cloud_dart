...
class MyselfApi {
  ...
  MyselfApi(this._dio, this._serializers);
  ...
  Future<Response<Object>> deleteLocale({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/mypreferences/locale";
  ...
  Future<Response<User>> getCurrentUser({
    ...
    String _path = "/rest/api/2/myself";
  ...
  Future<Response<Locale>> getLocale({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/mypreferences/locale";
    ...
    return _dio
      ...
      cancelToken: cancelToken,
        ...
        .then((response) {
      var serializer = _serializers.serializerForType(Locale);
      var data =
          _serializers.deserializeWith<Locale>(serializer, response.data);
  ...
  Future<Response<String>> getPreference(
    String key, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/mypreferences";
  ...
  Future<Response> removePreference(
    String key, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
  ...
  Future<Response<Object>> setLocale(
    Locale locale, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    ...
    var serializedBody = _serializers.serialize(locale);
    var jsonlocale = json.encode(serializedBody);
    bodyData = jsonlocale;
  ...
  Future<Response<Object>> setPreference(
    String key,
    String body, {
    CancelToken cancelToken,
    Map<String, String> headers,
