...
class ProjectRoleActorsApi {
  ...
  Future<Response<ProjectRole>> addActorUsers(
    ...
    String _path = "/rest/api/2/project/{projectIdOrKey}/role/{id}"
  ...
  Future<Response<ProjectRole>> addProjectRoleActorsToRole(
    int id,
    ...
    String _path =
        "/rest/api/2/role/{id}/actors".replaceAll("{" r'id' "}", id.toString());
  ...
  Future<Response<ProjectRole>> deleteProjectRoleActorsFromRole(
    int id, {
    String user,
    String group,
    CancelToken cancelToken,
  ...
  Future<Response<ProjectRole>> getProjectRoleActorsForRole(
    int id, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
  ...
  Future<Response<ProjectRole>> setActors(
    String projectIdOrKey,
    int id,
