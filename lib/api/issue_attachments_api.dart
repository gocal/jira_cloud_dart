...
class IssueAttachmentsApi {
  ...
  Future<Response<List<Attachment>>> addAttachment(
    String issueIdOrKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}/attachments"
  ...
  Future<Response<AttachmentArchiveMetadataReadable>> expandAttachmentForHumans(
    String id, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/attachment/{id}/expand/human"
  ...
  Future<Response<AttachmentArchiveImpl>> expandAttachmentForMachines(
    String id, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/attachment/{id}/expand/raw"
        .replaceAll("{" r'id' "}", id.toString());
  ...
  Future<Response<AttachmentMetadata>> getAttachment(
    String id, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path =
        "/rest/api/2/attachment/{id}".replaceAll("{" r'id' "}", id.toString());
  ...
  Future<Response<AttachmentSettings>> getAttachmentMeta({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/attachment/meta";
