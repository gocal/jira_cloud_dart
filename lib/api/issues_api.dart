...
class IssuesApi {
  ...
  Future<Response<Object>> assignIssue(
    String issueIdOrKey,
    User user, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}/assignee"
  ...
  Future<Response<CreatedIssue>> createIssue(
    Map<String, Object> requestBody, {
    bool updateHistory,
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue";
  ...
  Future<Response<CreatedIssues>> createIssues(
    Map<String, Object> requestBody, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/bulk";
  ...
  Future<Response> deleteIssue(
    String issueIdOrKey, {
    String deleteSubtasks,
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}"
        .replaceAll("{" r'issueIdOrKey' "}", issueIdOrKey.toString());
  ...
  Future<Response<Object>> doTransition(
    String issueIdOrKey,
    Map<String, Object> requestBody, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}/transitions"
        .replaceAll("{" r'issueIdOrKey' "}", issueIdOrKey.toString());
  ...
  Future<Response<Object>> editIssue(
    String issueIdOrKey,
    Map<String, Object> requestBody, {
    bool notifyUsers,
  ...
  Future<Response<PageBeanChangelog>> getChangeLogs(
    String issueIdOrKey, {
    int startAt,
    int maxResults,
    CancelToken cancelToken,
    ...
    String _path = "/rest/api/2/issue/{issueIdOrKey}/changelog"
        .replaceAll("{" r'issueIdOrKey' "}", issueIdOrKey.toString());
  ...
  Future<Response<IssueCreateMetadata>> getCreateIssueMeta({
    ...
    String _path = "/rest/api/2/issue/createmeta";
  ...
  Future<Response<IssueUpdateMetadata>> getEditIssueMeta(
    String issueIdOrKey, {
    bool overrideScreenSecurity,
    bool overrideEditableFlag,
    CancelToken cancelToken,
    ...
    String _path = "/rest/api/2/issue/{issueIdOrKey}/editmeta"
        .replaceAll("{" r'issueIdOrKey' "}", issueIdOrKey.toString());
  ...
  Future<Response<IssueBean>> getIssue(
    String issueIdOrKey, {
    List<String> fields,
    bool fieldsByKeys,
    String expand,
  ...
  Future<Response<Transitions>> getTransitions(
    String issueIdOrKey, {
    String expand,
    String transitionId,
    ...
    queryParams[r'sortByOpsBarAndStatus'] = sortByOpsBarAndStatus;
    queryParams.removeWhere((key, value) => value == null);
    headerParams.removeWhere((key, value) => value == null);
  ...
  Future<Response<Object>> notify(
    String issueIdOrKey,
    Map<String, Object> requestBody, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/issue/{issueIdOrKey}/notify"
        .replaceAll("{" r'issueIdOrKey' "}", issueIdOrKey.toString());
