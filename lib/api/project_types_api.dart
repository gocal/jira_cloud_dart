...
class ProjectTypesApi {
  ...
  Future<Response<ProjectType>> getAccessibleProjectTypeByKey(
    String projectTypeKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/type/{projectTypeKey}/accessible"
  ...
  Future<Response<List<ProjectType>>> getAllAccessibleProjectTypes({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/type/accessible";
  ...
  Future<Response<List<ProjectType>>> getAllProjectTypes({
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/type";
  ...
  Future<Response<ProjectType>> getProjectTypeByKey(
    String projectTypeKey, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/type/{projectTypeKey}"
        .replaceAll("{" r'projectTypeKey' "}", projectTypeKey.toString());
