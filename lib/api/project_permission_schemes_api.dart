...
class ProjectPermissionSchemesApi {
  ...
  Future<Response<PermissionScheme>> assignPermissionScheme(
    ...
    String _path = "/rest/api/2/project/{projectKeyOrId}/permissionscheme"
  ...
  Future<Response<PermissionScheme>> getAssignedPermissionScheme(
    String projectKeyOrId, {
    String expand,
    CancelToken cancelToken,
    Map<String, String> headers,
  ...
  Future<Response<SecurityScheme>> getProjectIssueSecurityScheme(
    String projectKeyOrId, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
  ...
  Future<Response<ProjectIssueSecurityLevels>> getSecurityLevelsForProject(
    String projectKeyOrId, {
    CancelToken cancelToken,
    Map<String, String> headers,
  }) async {
    String _path = "/rest/api/2/project/{projectKeyOrId}/securitylevel"
        .replaceAll("{" r'projectKeyOrId' "}", projectKeyOrId.toString());
